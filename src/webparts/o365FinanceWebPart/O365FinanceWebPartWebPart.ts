...
import ViewECCDetails from "./components/ViewECCDetails.vue";
import DetailPurchaseTask from "./components/DetailPurchaseTask.vue";
...
export default class O365FinanceWebPartWebPart extends BaseClientSideWebPart<IO365FinanceWebPartWebPartProps> {
  ...
  public render(): void {
    ...
    const routes = [
      ...
      { path: '/vieweccdetails', component: ViewECCDetails },
      { path: '/detailPurchaseReport', component: DetailPurchaseTask },
