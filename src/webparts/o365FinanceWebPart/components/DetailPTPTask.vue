<template>
  <div>
    <table class="ptpDetail" style="table-layout：fixed">
      <tr>
        <td colspan="8">
      ...
      <tr>
        ...
        <td align="left">
          <el-input disabled v-model="purchaseRequestData.ApplicationType " placeholder="委托/经办人"></el-input>
        </td>
        <td align="right">费用类别：</td>
        <td>
          <el-input disabled v-model="purchaseRequestData.ExpenseCategory " placeholder="委托/经办人"></el-input>
        </td>
        <td align="right">费用科目：</td>
        <td colspan="3" align="left">
          <el-input disabled v-model="purchaseRequestData.CostAccount " placeholder="委托/经办人"></el-input>
        </td>
      </tr>
      <tr>
